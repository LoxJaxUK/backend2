...
export const seedDatabase = async () => {
  try {
    ...
    console.log("Users seeded (Admin, Manager, Kitchen, Service) - server.ts:40");
    ...
    console.log("Tasks seeded - server.ts:48");
    ...
    console.log("Rules seeded - server.ts:56");
    ...
    console.log("Videos seeded - server.ts:64");
  } catch (error) {
    console.error("Seed Error: - server.ts:66", error);
  }
};